...
var addToHome = (function (w) {
  ...
  /* Bridgeway: code-or-modified - Adding support for Android devices */

  /* Bridgeway: code-or-modified */
  var ua = navigator.userAgent.toLowerCase();
  var isAndroid = ua.indexOf("android") > -1;
  var isAndroidPhone = (isAndroid && (ua.indexOf("mobile") > -1) );
  // alert('isAndroid='+isAndroid+' isAndroidPhone='+isAndroidPhone);

	var nav = w.navigator,
		isIDevice = 'platform' in nav && ((/iphone|ipod|ipad/gi).test(nav.platform) || isAndroid),  /* Bridgeway: code-or-modified */
		isIPad,
		isRetina,
		isSafari,
		isStandalone,
  ...
  //alert('isIDevice='+isIDevice+'\r\nnav.platform='+nav.platform + '\r\nuserAgent='+ua + '\r\nisAndroid='+isAndroid+'\r\nisAndroidPhone='+isAndroidPhone);
    ...
    /* Bridgeway: code-or-modified */
    if (isAndroid) {
      if (isAndroidPhone && options.messageForAndroidPhone) {
        options.message = options.messageForAndroidPhone;
      } else if (options.messageForAndroidTablet) {
        options.message = options.messageForAndroidTablet;
      }
    }
